...
3. Do not make any unnecessary changes to the source. You may only change or add stuff within the `SynthLauncherDocs/docs` folder. Do not make any changes to the configuration files or folders which contain crucial 
elements.
