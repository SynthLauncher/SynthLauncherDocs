...
:::
:::info Note 2
Pull requests for the documentation will not be reviewed until we finish all the main documentation.
:::
:::info Note 3
...
## Guidelines
1. Use proper grammar and punctuation. We try to keep these pages well-written.
...
3. Do not attempt to make any unnecessary changes to the source. You may only change or add `.mdx` files within the `SynthLauncherDocs/docs` folder. Do not make any changes to the configuration files or folders which contain crucial 
elements.
...
5. Do not provide any misinformation; this goes without saying. This wiki is a knowledge resource.
...
Skip to [Section 2](#section-2-writing-docs) if you already have these programs.
:::
...
Just make sure to follow the [guidelines.](docs#guidelines)
